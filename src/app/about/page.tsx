    ...
    <>
      ...
      <Container maxWidth="lg" className="container">
        ...
        <Typography variant="body2" paragraph>
          OpenBC, a community-driven initiative dedicated to harnessing the
          ...
          together individuals passionate about technology, civic engagement,
          and community development to address the unique challenges and
          opportunities faced by our province.
        </Typography>
        <Typography variant="body2" paragraph>
          <strong>
        ...
        <Typography variant="body2" paragraph>
          ...
          or a community leader, your skills can play a crucial role in
